...
if __name__ == '__main__':
    ...
    for pattern in patterns:
            ...
            if check_projection(c, p):
                ...
                renders_info[render_filename] = {'pattern': 
                                                    {'location': [p.location.x, p.location.y, p.location.z],
                                                        'rotation': [p.rotation_euler[0], p.rotation_euler[1], p.rotation_euler[2]]
                                                    }
                                                }
                n += 1
        ...
        with open(os.path.join(pattern_dir, 'info.yaml'), 'w') as info_file:
